...
ActiveRecord::Schema.define(version: 20170115075603) do
  ...
  create_table "profile_contact_joins", id: :serial, force: :cascade do |t|
    t.integer "profile_id"
    t.integer "contact_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["contact_id"], name: "index_profile_contact_joins_on_contact_id"
    t.index ["profile_id"], name: "index_profile_contact_joins_on_profile_id"
  end
